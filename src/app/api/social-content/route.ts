...
export async function POST(req: NextRequest) {
  ...
  const { brand, count, platforms, contentTypes, formatPreference, notes, strategy } = await req.json()
  ...
  const userPrompt = `Generate ${postCount} social media content pieces for this brand. Each piece is ONE design concept that works across all platforms, with caption variants per platform.
