// Template 003 — "Logo at the top left"
// Brand-mark ring top-left, "Invoice" meta top-right.

import type { InvoiceData } from './types'
import { palette, fmtDate } from './shared'
import { BrandMark, Party, ItemsList, Totals, Footer } from './BrandMark'

export function StructuredTemplate({ data }: { data: InvoiceData }) {
